<%@ Page Title="" Language="C#" MasterPageFile="~/Bienvenida_logIng.Master" AutoEventWireup="true" CodeBehind="Registro_Usuario.aspx.cs" Inherits="WEBZONE.Registro_Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h1 class="text-dark" style="margin-left: 50px; margin-top: 20px;"> Registrate</h1>
                ...
                <div class="row">
                    <div class="row col-md-10 form-check" style="margin: 30px;">
                      ...
                      <asp:Button Text="Guardar" runat="server" class="btn btn-success" OnClick="Guardar_Usuario" />
                        <a href="Log_IN.aspx" class="btn btn-danger">Cancelar</a>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="Log_IN.aspx" class="btn btn-info">Continuar</a>
