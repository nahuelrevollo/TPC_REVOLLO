...
namespace WEBZONE
{
    public partial class Modif_DatosAdmin : System.Web.UI.Page
    {
        ...
        protected void Btn_ModificarDP(object sender, EventArgs e)
        {
...

            {
                try
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "Modal_Modif_DPad", "$('#Modal_Modif_DPad').modal();", true);
                    upModal.Update();

                    Response.Redirect("Perfil_Admin.aspx");
