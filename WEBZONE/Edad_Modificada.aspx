<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MP.Master" AutoEventWireup="true" CodeBehind="Edad_Modificada.aspx.cs" Inherits="WEBZONE.Edad_Modificada" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h1 class="text-dark" style="margin-left: 50px; margin-top: 20px;">Modificar Edad</h1>
