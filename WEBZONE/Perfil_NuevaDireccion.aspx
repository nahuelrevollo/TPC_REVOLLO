<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Perfil_NuevaDireccion.aspx.cs" Inherits="WEBZONE.Perfil_NuevaDireccion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="margin-left: 500px;">
        <div class="col-md-12">
            ...
            <div class="row">
                    <div class="row col-md-10 form-check" style="margin: 30px;">
                      ...
                      <asp:Button Text="Guardar" runat="server" class="btn btn-success" OnClick="Guardar_Direccion_N" />
     ...
     <div class="modal fade" id="modalNdir" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="Compra_Finalizada" class="btn btn-info">Continuar</a>
