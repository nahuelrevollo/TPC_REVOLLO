<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MP.Master" AutoEventWireup="true" CodeBehind="Modif_DatosAdmin.aspx.cs" Inherits="WEBZONE.Modif_DatosAdmin" %>
...
<asp:RegularExpressionValidator ErrorMessage="No puede contener numeros!" ControlToValidate="nombre_u" CssClass="alert alert-danger" runat="server" ValidationExpression="^[a-zA-Z ]*$" />
                    ...
                    <asp:Button Text="Modificar" runat="server" class="btn btn-success" OnClick="Btn_ModificarDP"/>
                        <a href="Perfil_Admin.aspx" class="btn btn-danger">Cancelar</a>
                </div>
                </div>
            </div>
        </div>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager> 
     ...
     <div class="modal fade" id="Modal_Modif_DPad" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="Perfil_Admin.aspx" class="btn btn-info">Continuar</a>
