<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MP.Master" AutoEventWireup="true" CodeBehind="Nuevo_Articulo.aspx.cs" Inherits="WEBZONE.Nuevo_Articulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h1 class="text-dark" style="margin-left: 50px; margin-top: 20px;"> Nuevo Articulo</h1>
            ...
            <div class="row col-center">
                ...
                <div class="row">
                    <div class="row col-md-10 form-check" style="margin: 30px;">
                        ...
                        <div class="row">
                            <label class="form-check-label text-dark">Precio unitario:</label>
                ...
                <div class="row">
                    <div class="row col-md-10 form-check" style="margin: 30px;">
                      ...
                      <asp:Button Text="Guardar" runat="server" class="btn btn-success" OnClick="Btn_GuardarArticulo" />
