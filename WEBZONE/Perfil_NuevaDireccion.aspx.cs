...
namespace WEBZONE
{
    public partial class Perfil_NuevaDireccion : System.Web.UI.Page
    {
        ...
        protected void Guardar_Direccion_N(object sender, EventArgs e)
        {
...

            {
                try
                {
                    ...
                    if (direccion.IDusuario != 0)
                    {
                        ...
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "modalNdir", "$('modalNdir').modal();", true);
                        upModal.Update();
