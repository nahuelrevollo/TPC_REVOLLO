<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MP.Master" AutoEventWireup="true" CodeBehind="Nueva_Marca.aspx.cs" Inherits="WEBZONE.Nueva_Marca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h1 class="text-dark" style="margin-left: 50px; margin-top: 20px;">Nueva Marca</h1>
