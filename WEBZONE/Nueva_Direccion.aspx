<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Nueva_Direccion.aspx.cs" Inherits="WEBZONE.Nueva_Direccion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="margin-left: 500px;">
        <div class="col-md-12">
            ...
            <div class="row">
                    <div class="row col-md-10 form-check" style="margin: 30px;">
                      ...
                      <asp:Button Text="Enviar por esta vez" runat="server" class="btn btn-success" OnClick="Direccion_Envio" />
                        <a href="Direccion_Envio.aspx" class="btn btn-danger">Cancelar</a>
     ...
     <div class="modal fade" id="modalNueva_dir" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <asp:Label ID="lblModalTitle" runat="server" Text="">Direccion creada con exito!</asp:Label>
                            </h4>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="CompraFinalizada" class="btn btn-info">Continuar</a>
