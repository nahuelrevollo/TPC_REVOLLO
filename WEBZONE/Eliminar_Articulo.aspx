<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MP.Master" AutoEventWireup="true" CodeBehind="Eliminar_Articulo.aspx.cs" Inherits="WEBZONE.Eliminar_Articulo" %>
            ...
            <div class="col">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="Eliminar_Articulo.aspx?idEliminar=<% = mod_art.ID.ToString() %>" class="btn btn-primary">Eliminar</a></td>
                    </tr>
